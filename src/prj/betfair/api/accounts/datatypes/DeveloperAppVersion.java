...
public class DeveloperAppVersion {
  ...
  /**
   * @return delayData Indicates whether the data exposed by platform services as seen by this
  ...
  /**
   * @return subscriptionRequired Indicates whether the application version needs explicit
   *         subscription
   */
  ...
  /**
   * @return ownerManaged Indicates whether the application version needs explicit management by
   *         producers. A value of false indicates, this is a version meant for developer use.
   */
  ...
  public static class Builder {
    ...
    /**
     * @param ownerManaged : Indicates whether the application version needs explicit management by
     *        producers. A value of false indicates, this is a version meant for developer use.
     * @param applicationKey : The unqiue application key associated with this application version
     * @param subscriptionRequired : Indicates whether the application version needs explicit
     *        subscription
     * @param versionId : The unique Id of the application version
     * @param version : The version identifier string such as 1.0, 2.0. Unique for a given
     *        application.
     ...
     *        application key is delayed or realtime.
     */
    public Builder(@JsonProperty("ownerManaged") boolean ownerManaged,
        @JsonProperty("applicationKey") String applicationKey,
        @JsonProperty("subscriptionRequired") boolean subscriptionRequired,
        @JsonProperty("versionId") long versionId, @JsonProperty("version") String version,
        @JsonProperty("owner") String owner, @JsonProperty("active") boolean active,
        @JsonProperty("delayData") boolean delayData) {
